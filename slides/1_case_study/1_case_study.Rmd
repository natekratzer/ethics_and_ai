...
Risk scores are on a scale of 1-20. Where do you think these two case fall?
...
"So the AFST actually predicts decisions made by the community (which families will be reported to the hotline) and by the agency and the family courts (which children will be removed from their families), not which children will be harmed"
